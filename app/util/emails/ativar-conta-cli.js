module.exports = (url, token) => {
    return `<!DOCTYPE html>
            ...
            <head>
                ...
                <title>Ativação conta BoxPets</title>
                <style>
                    * {
                        padding: 0;
                        margin: 0;
            ...
            <body>
                <section class="ativacao__container">
                    <header>
                        <h2 class="title">Bem-vindo ao <span style="color: var(--cor-secundaria)">Box<span
                                    style="color: var(--cor-principal)">Pets</span></span>!</h2>
                    </header>
                    <article>
                        <p class="text">Obrigado por se cadastrar! Clique abaixo para ativar sua conta!</p>
                        <a href="${url}/ativar-conta-cli?token=${token}" class="btn" style="display: inline-block; padding: 10px 20px; background-color: #E6781E; color: #ffffff; text-decoration: none; border-radius: 5px;">Ativar conta</a>
                    </article>
                    <footer>
