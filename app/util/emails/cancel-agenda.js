module.exports = (url, infos) => {
    return `<!DOCTYPE html>
            ...
            <head>
                ...
                <title>Cancelamento do agendamento</title>
                <style>
                    * {
                        padding: 0;
                        margin: 0;
            ...
            <body>
                <section class="ativacao__container">
                    <header>
                        <h2 class="title">Cancelamento do agendamento no servico ${infos.servico.NOME_SERVICO}</h2>
                    </header>
                    <article>
                    ...
                    <footer>
                        <p class='text'>Ignore esse e-mail caso não tenha agendado.</p>
                    </footer>
                </section>
            </body>
